package uy.com.equipos.panelmanagement.views.propiedades;
...
@RolesAllowed("ADMIN")
public class PropiedadesView extends Div implements BeforeEnterObserver {
    ...
    public PropiedadesView(PanelistPropertyService panelistPropertyService) {
        this.panelistPropertyService = panelistPropertyService;
        addClassNames("propiedades-view");
        ...
        grid.asSingleSelect().addValueChangeListener(event -> {
            if (event.getValue() != null) {
                ...
                clearForm();
                UI.getCurrent().navigate(PropiedadesView.class);
            }
        });
    ...
    public void beforeEnter(BeforeEnterEvent event) {
        ...
        if (panelistPropertyId.isPresent()) {
            ...
            if (panelistPropertyFromBackend.isPresent()) {
                ...
                // refresh grid
                refreshGrid();
                event.forwardTo(PropiedadesView.class);
            }
        }
    }
