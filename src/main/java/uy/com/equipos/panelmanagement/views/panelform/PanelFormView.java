package uy.com.equipos.panelmanagement.views.panelform;
...
@PageTitle("Panel Form")
@Route("address-form")
@Menu(order = 3, icon = LineAwesomeIconUrl.CPANEL)
@AnonymousAllowed
public class PanelFormView extends Composite<VerticalLayout> {
